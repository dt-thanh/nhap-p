    ...
    <div className="flex min-h-screen bg-surface-page">
      ...
      <div className="relative hidden w-[46%] flex-col justify-between overflow-hidden bg-navy-900 px-12 py-14 lg:flex">
        <div className="relative z-10 flex flex-col items-center text-center">
          <div className="flex h-20 w-20 items-center justify-center rounded-xl border-2 border-gold font-display text-2xl font-bold text-gold">
            AF
          </div>
          ...
          <p className="mt-4 max-w-xs text-sm leading-relaxed text-white/70">
            Giải pháp bán hàng bất động sản thông minh cho nhà phát triển hiện
            đại
          </p>
        </div>
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&w=900&q=70')",
          }}
        />
      </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12">
        ...
        <p className="mt-6 text-xs text-ink-faint">
          © 2024 AbsorptionForecast CRM. Bảo lưu mọi quyền.
        </p>
