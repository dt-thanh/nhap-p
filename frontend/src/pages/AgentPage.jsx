...
function RecommendationCard({ data, loading, me, canApprove, canExecute, actor, setActor, reason, setReason, decide, execute, regenerate }) {
  ...
  return <div>
    ...
    {data.execution_status === "executed" && <div style={S.success}><b>Đã thực thi thành công</b><span>Chiến dịch: {data.execution_result?.campaign_id}</span><span>{data.execution_result?.unit_count} căn được đưa vào chiến dịch.</span></div>}
