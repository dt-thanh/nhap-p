  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <ProjectEmptyState navigate={navigate} />
  ...
  return (
    <article style={S.card}>
      <button
        ...
        title={hasIdentity ? undefined : "Dự án chưa có external ID — chưa thể mở workspace"}
...
function ProjectsErrorState({ error, onRetry }) {
  return (
    <div style={S.stateWrap} data-testid="projects-error">
      ...
      <p style={S.stateText}>Dữ liệu chưa được cập nhật. Vui lòng thử lại hoặc kiểm tra trạng thái kết nối.</p>
...
function ProjectEmptyState({ navigate }) {
  return (
    <div style={S.stateWrap} data-testid="projects-empty">
      ...
      <p style={S.stateText}>Tạo dự án đầu tiên để bắt đầu theo dõi hiệu suất kinh doanh.</p>
      <button type="button" style={S.primaryButton} onClick={() => navigate("/catalog")}>Tạo dự án mới</button>
    </div>
  );
}
