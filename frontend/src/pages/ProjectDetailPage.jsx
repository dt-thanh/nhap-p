...
// S03 — Giới thiệu dự án và danh mục phân khu. Dashboard của phân khu là một
// route riêng tại /projects/:id/areas/:areaId; trang này chỉ giữ ngữ cảnh dự án
// và danh mục phân khu.
      ...
      <section aria-labelledby="areas-title" style={S.catalogSection}>
          ...
          {!areasLoading && !areasError && areas.length === 0 && (
            <div data-testid="areas-empty" style={S.inlineState}>
              ...
              <button type="button" onClick={() => navigate(`/catalog?project=${encodeURIComponent(projectExternalId)}`)} style={S.addBtn}>Thêm phân khu</button>
            </div>
          )}
