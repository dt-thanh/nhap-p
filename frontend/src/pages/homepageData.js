...
export const PLATFORM_FEATURES = [
  ...
  { icon: "filter", number: "03", title: "So sánh dự án và phân khu", description: "Đặt quy mô, tồn kho và chỉ báo hấp thụ cạnh nhau để kiểm tra dữ liệu trước khi trao đổi bước tiếp theo." },
